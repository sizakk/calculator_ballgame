      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ExpResult(
            ...
            runScores_2: int.parse(runScores_2.toString()),
            eRunScores_2: int.parse(eRunScores_2.toString()),
            runScores_3: int.parse(runScores_3.toString()),
            eRunScores_3: int.parse(eRunScores_3.toString()),
            runScores_4: int.parse(runScores_4.toString()),
            eRunScores_4: int.parse(eRunScores_4.toString()),
            runScores_5: int.parse(runScores_5.toString()),
            eRunScores_5: int.parse(eRunScores_5.toString()),
            runScores_6: int.parse(runScores_6.toString()),
            eRunScores_6: int.parse(eRunScores_6.toString()),
            runScores_7: int.parse(runScores_7.toString()),
            eRunScores_7: int.parse(eRunScores_7.toString()),
            runScores_8: int.parse(runScores_8.toString()),
            eRunScores_8: int.parse(eRunScores_8.toString()),
            runScores_9: int.parse(runScores_9.toString()),
            eRunScores_9: int.parse(eRunScores_9.toString()),
            runScores_10: int.parse(runScores_10.toString()),
            eRunScores_10: int.parse(eRunScores_10.toString()),
          ),
        ),
      );
    } else {}
